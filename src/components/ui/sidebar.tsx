  ...
  (
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            'duration-75 fixed inset-y-0 z-10 hidden h-svh w-[--sidebar-width] transition-[left,right,width] ease-linear md:flex',
            side === 'left'
...
>(({ className, ...props }, ref) => {
  return (
    <div
      ref={ref}
      data-sidebar="footer"
      className={cn('flex justify-between gap-2  p-4', className)}
      {...props}
    />
  );
});
